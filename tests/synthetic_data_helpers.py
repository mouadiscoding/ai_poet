...
def valid_qcm_value(poem: PoemRecord) -> dict[str, object]:
    ...
    return {
        ...
        "choices": {
            "ا": "مدح المخاطَب والإشادة بعلمه وفقهه.",
            "ب": "السخرية من التناقض بين مظهر المخاطَب وادعائه للعلم وبين انشغاله باللهو والملذات.",
            "ج": "وصف رحلة المخاطَب من مدينة إلى أخرى.",
            "د": "التعبير عن إعجاب الشاعر بقدرة المخاطَب على نظم الشعر.",
        },
        "reasoning": (
            ...
            "وبمقارنة هذه المعطيات بالاختيارات، نجد أن الاختيار ب هو الذي يجمع "
